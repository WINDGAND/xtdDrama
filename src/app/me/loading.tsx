      ...
      <div className="mx-auto w-full max-w-3xl">
        <div className="flex items-end justify-between gap-4">
          <div className="flex flex-col gap-2 min-w-0">
            <div className="h-8 w-32 rounded-md bg-zinc-100 dark:bg-white/[0.06] animate-pulse" />
            <div className="h-4 w-56 max-w-full rounded-md bg-zinc-100 dark:bg-white/[0.06] animate-pulse" />
          </div>
